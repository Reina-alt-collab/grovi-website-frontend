...
export default async function ProjectPage({ params }) {
  ...
  return (
    <article className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-display font-bold text-center mb-8">{project.title}</h1>
      ...
      <div className="prose lg:prose-xl max-w-3xl mx-auto">
        <h2 className="font-display text-3xl font-semibold">El Reto</h2>
        <PortableText value={project.theChallenge} />

        <h2 className="font-display text-3xl font-semibold mt-10">La Metodología</h2>
        <PortableText value={project.theMethodology} />

        <h2 className="font-display text-3xl font-semibold mt-10">Los Resultados</h2>
